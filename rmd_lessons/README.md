...
|------------|----------------|-------|
| **01.0_intro_to_R/** | Introduction to R, R basics, RStudio overview | `1.0_intro_to_R.Rmd` |
| **02.0_vectors/** | Creating and manipulating vectors, vector types | `2.0_vectors.Rmd` |
| **03.0_functions/** | Using functions, arguments, return values | `3.0_functions.Rmd` |
| **04.0_vector_operations/** | Comparison operators, logical comparisons, missing data | `4.0_vector_operations.Rmd` |
| **05.0_review/** | Review of basic R concepts (vectors, functions, operations) | `5.0_review.Rmd` |
...
| **07.0_tidyverse/** | Introduction to the tidyverse, tidying data, `select()` and `filter()` | `7.0_tidyverse_worksheet.Rmd`, `7.0_tidyverse_worksheet_KEY.Rmd`, `7.1_tidyverse_group_activity.Rmd`, `7.2_tidyverse_exercises.Rmd`, `7.2_tidyverse_exercises_KEY.Rmd`,  |
...
| **12.0_plots2/** | Advanced plotting: themes, aesthetics, customization | `12.0_plots_2.0_lesson.Rmd`, `12.0_plots_2.0_lesson_KEY.Rmd` |
